...
\begin{table}[htbp]
\centering
\caption{Error relativo mediano (\%) por indicador institucional según número de años de datos ($k$).}
...
\caption{Asignación de los 65 establecimientos a los clústeres de Nivel~1 y Nivel~2 (Ward) y categoría MINSAL.}
