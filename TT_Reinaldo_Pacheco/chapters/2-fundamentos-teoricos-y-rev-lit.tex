...
agregada de la producción de un hospital, concepto conocido como casuística.
...
determaran los resultados. En cada nivel se identificaron tres grupos de
...
promedio ajustados por casuística. El modelo final incluyó cinco
...
Esta línea de trabajo ha explorado sistemáticamente la aplicación de técnicas
computacionales avanzadas para superar las limitaciones de las clasificaciones
administrativas vigentes.

El trabajo de \citet{Villalobos2016} introdujo un enfoque basado en teoría de
grafos para construir grupos homogéneos de hospitales según su casuística, en
un contexto donde los datos GRD no estaban aún plenamente consolidados. Los
autores desarrollaron una metodología para identificar grupos homogéneos de
establecimientos comparables, permitiendo evaluar eficiencia técnica entre
hospitales con perfiles de producción equivalentes dentro de cada grupo.

\citet{Carlier2020} evaluaron directamente si la categorización
administrativa del Ministerio de Salud se corresponde con la casuística
...
establecer que la categorización MINSAL refleja la casuística de los
...
filtradas por correlación con los pesos DRG, aproximando así la casuística
...
que varios hospitales estaban mal asignados según el criterio de casuística.
...
etiquetas administrativas vigentes no reflejan adecuadamente la
casuística real de los hospitales~\citep{Carlier2020, Giglio2021} y de que los
métodos de agrupamiento basados en datos de producción generan particiones con
mayor coherencia interna. No obstante, estos trabajos también evidenciaron
limitaciones metodológicas que motivan la presente investigación.
...
datos clínicos, reflejados en variables como casuística, complejidad clínica,
estancia media y perfiles de procedimientos, revelen qué
...
iterativamente los pares de observaciones o clústeres más cercanos según una
...
separados~\citep{CalinskiHarabasz1974}.
...
perspectiva de interpretabilidad~\citep{DaviesBouldin1979, Arbelaitz2013}.
