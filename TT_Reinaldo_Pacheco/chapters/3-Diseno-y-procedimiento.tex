...
Lo que valida la solución empírica no es únicamente su comparación de
homogeneidad frente a MINSAL, sino el conjunto de evidencia presentado en
...
submuestreo (Sección~\ref{sec:bootstrap}) y la significancia estadística de
las diferencias entre grupos (Sección~\ref{sec:validacion-grupos}), con las
salvedades de circularidad ya señaladas en esa misma sección. El contraste con
MINSAL es un componente adicional de esa evidencia, no la validación
principal: aporta información sobre qué hospitales cambian de categoría entre
ambas perspectivas y sobre cuál de las dos particiones exhibe mayor cohesión
interna, lo que tiene valor directo para la gestión sanitaria.
...
(35) es del mismo orden que el número de observaciones. En su lugar se implementa
una estrategia que combina tres criterios complementarios, cada uno sensible a
una faceta distinta de la atipicidad:
