...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{img/metricas_nivel2.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{img/seleccion_nivel2.png}
...
\begin{minipage}{\textwidth}
\footnotesize\raggedright
\textit{Nota.} Los tamaños de efecto $\varepsilon^2$ se calculan para la
partición exploratoria del Nivel~2 ($n=54$, $K_{sub}=10$). No son directamente
comparables con los de la Tabla~\ref{tab:kruskal-nivel1}, calculados para el
Nivel~1 ($n=65$, $K=4$), porque el número y tamaño de los grupos, así como el
tamaño muestral, son distintos.
\end{minipage}
\end{table}
...
\caption{Proyección PCA de los establecimientos según la partición Ward $K=4$. PC1 y PC2 explican el 32{,}9\,\% y el 19{,}0\,\% de la varianza, respectivamente. Los círculos rojos corresponden a hospitales marcados por al menos un criterio de detección de atipicidad. La posición de San Borja--Arriarán y Gustavo Fricke en esta proyección bidimensional no resume todas las dimensiones empleadas en su criterio de distancia al centroide.}
