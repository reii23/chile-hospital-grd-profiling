...
\begin{table}[htbp]
\centering
\caption{Búsqueda de subclústeres Ward en el núcleo generalista (Nivel~2, $n=54$). La solución suplementaria reportada es $K_{sub}=9$: conserva siete grupos con al menos cuatro hospitales y no introduce pares, aunque mantiene dos grupos unitarios.}
