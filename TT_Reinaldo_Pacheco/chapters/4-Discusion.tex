...
Estos resultados muestran que, sobre la matriz funcional utilizada en este
estudio, las soluciones Ward presentan grupos más compactos que la clasificación
MINSAL. No obstante, esta comparación es interna al mismo espacio de variables
empleado para construir el clustering. Por ello, describe la compactación de
cada partición respecto de la actividad clínica, pero no constituye una
validación externa ni permite concluir que una clasificación sea superior a la
otra para propósitos administrativos, de financiamiento o de gestión.
