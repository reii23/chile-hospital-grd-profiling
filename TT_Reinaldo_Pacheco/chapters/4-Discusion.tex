...
fue 22 variables significativas, el percentil 95 fue 26 y el máximo fue 28. En
40 de 500 réplicas la nula igualó o superó las 26 variables observadas
($p_{\mathrm{emp}}=0{,}0818$, con corrección de continuidad). Por tanto, el
...
grupos explícita. Estas pruebas mantienen utilidad descriptiva para ordenar los
...
Normal multivariada con covarianza preservada & 22 & 26 & 28 & 0,0818 \\
\bottomrule
\end{tabular}
\par\smallskip
\begin{minipage}{\textwidth}
...
segunda nula, la covarianza se preserva en esperanza; el error relativo mediano
entre la covarianza muestral simulada y la observada fue 0,310.
\end{minipage}
\end{table}
