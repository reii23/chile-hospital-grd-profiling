...
proporción de ingresos obstétricos es alta (Pearson $r=0{,}928$; Spearman
$\rho=0{,}924$; $n=65$), por lo que ambas variables contienen información
...
umbral de redundancia predefinido ($\rho=0{,}875$). Por transparencia, ambas
variables se conservan en la matriz canónica; esta redundancia se considera al
interpretar el peso del bloque demográfico-obstétrico y no permite atribuir el
resultado a una medida independiente de partos.
...
Proporción de egresos neonatales & 2,1\% & 3,1\% & 4,4\% & 4,3\% & 5,1\% &
3,4\% & 2,6\% & 2,8\% & 2,3\% & 1,9\% \\
\bottomrule
\end{tabular}%
}
...
\begin{itemize}
    ...
    de pabellón alcanza $46{,}3\%$ y la proporción de egresos neonatales $4{,}4\%$. Está compuesto
    por:
    \begin{itemize}
    ...
    de 7,0 días, peso medio GRD de 0,978 y proporción de egresos neonatales de $4{,}3\%$. Está
    compuesto por:
    \begin{itemize}
