...
Tasa de partos & 2,5\% & 1,4\% & 0,000\% & 2,7\% & 5,6\% \\
...
demográfico-obstétrico aporta $37{,}1\%$ de la distancia total, la fracción más
...
$62{,}9\%$ de la distancia, por lo que la partición no puede atribuirse solo a
la demografía.
...
\midrule
Gestión, diversidad y CMA & 9 & 15,2\% \\
Perfil operativo no demográfico & 11 & 27,1\% \\
Demográfico-obstétrico & 7 & 37,1\% \\
Componentes PCA de casuística & 8 & 20,6\% \\
\bottomrule
\end{tabular}
\end{table}
...
Al excluir las siete variables demográfico-obstétricas, la partición mantiene
una concordancia alta con la original ($ARI=0{,}933$; $NMI=0{,}906$): los tres
hospitales pediátricos y los tres de perfil monográfico permanecen agrupados,
los 54 hospitales del núcleo continúan juntos y solo uno de los cinco miembros
del grupo $C2$ se incorpora al núcleo. La menor cohesión de esta solución
(Silhouette $=0{,}320$ frente a $0{,}401$) indica que el bloque excluido aporta
separación, pero su remoción no elimina los perfiles principales.
...
\midrule
Base & 35 & 0,401 & 0,990 & 1,000 & 1,000 \\
Ponderación por bloque & 35 & 0,409 & 0,974 & 1,000 & 1,000 \\
Sin demográfico-obstétrico & 28 & 0,320 & 1,036 & 0,933 & 0,906 \\
\bottomrule
\end{tabular}
\par\smallskip
...
las componentes PCA de casuística se conservan porque mezclan múltiples
...
\midrule
2 & 0,605 & 26,1 & 0,485 & 62, 3 \\
3 & 0,447 & 24,0 & 1,249 & 54, 8, 3 \\
\bfseries 4 & \bfseries 0,401 & \bfseries 22,4 & \bfseries 0,990 &
\bfseries 54, 5, 3, 3 \\
5 & 0,187 & 19,8 & 1,516 & 38, 16, 5, 3, 3 \\
6 & 0,189 & 18,6 & 1,292 & 38, 16, 5, 3, 2, 1 \\
7 & 0,197 & 17,4 & 1,167 & 38, 16, 3, 3, 2, 2, 1 \\
8 & 0,124 & 16,5 & 1,312 & 22, 16, 16, 3, 3, 2, 2, 1 \\
9 & 0,139 & 16,1 & 1,300 & 22, 16, 9, 7, 3, 3, 2, 2, 1 \\
10 & 0,138 & 15,5 & 1,192 & 22, 15, 9, 7, 3, 3, 2, 2, 1, 1 \\
\bottomrule
\end{tabular}
\end{table}

Como muestra la Tabla~\ref{tab:metricas-nivel1}, la solución $K=2$ obtiene simultáneamente el mejor resultado en las tres
métricas internas, con Silhouette $=0{,}605$, Calinski-Harabasz $=26{,}1$ y
...
pues identifica un núcleo de 54 hospitales generalistas, tres hospitales pediátricos, tres establecimientos de perfil monográfico y un grupo de cinco
hospitales con una combinación particular de
carga clínica, estancia y composición de pacientes. La solución presenta un
Silhouette de $0{,}401$ y un Davies-Bouldin de $0{,}990$. En consecuencia, no se
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{img/dendrograma_ward_nivel1.png}
\caption{Dendrograma de agrupamiento jerárquico global del Nivel 1 mediante
Ward aglomerativo. Las líneas discontinuas muestran los cortes para $K=2$,
$K=3$ y $K=4$.}
...
Tasa de partos & 0,0\% & 2,8\% & 0,461\% & 0,0\% \\
...
\begin{itemize}
    ...
    \item \textbf{Clúster $C3$ ($n=3$): perfil monográfico.} Registra el peso
    medio GRD más alto entre los cuatro perfiles (mediana $1{,}874$), la mayor
    edad mediana de la red ($63{,}6$ años), una estancia media de $8{,}7$ días
    y actividad obstétrica, pediátrica y CMA nula. Integra al Instituto Nacional
    de Enfermedades Respiratorias y Cirugía Torácica (INER), al Instituto de
    Neurocirugía Dr.\ Alfonso Asenjo y al Hospital Dr.\ Eduardo Pereira Ramírez
    de Valparaíso. Estas características permiten describirlo como un perfil
    predominantemente monográfico. Sin embargo, la heterogeneidad de los
    coeficientes Silhouette impide considerar inequívoca la asignación individual
    de sus tres establecimientos a $C3$.
    ...
    de 13.124 egresos anuales, estancia media de $6{,}8$ días, peso medio GRD de $0{,}947$ y una composición asistencial mixta, con $14{,}2\%$ de egresos pediátricos, $25{,}6\%$ de egresos geriátricos, $20{,}0\%$ de ingresos obstétricos y una tasa de partos de $2{,}8\%$. La diversidad y el equilibrio relativo de su actividad
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{img/pca_particiones_nivel1.png}
...
\begin{table}[htbp]
\centering
\caption{Estabilidad por submuestreo del Nivel~2 (100 réplicas del 80\,\% del núcleo generalista). Los intervalos corresponden a los percentiles 2,5 y 97,5.}
...
\midrule
2 & 0,169 & 0,507 [$-0,071$; 0,906] & 0,486 [0,024; 0,851] \\
3 & 0,080 & 0,354 [0,177; 0,795] & 0,459 [0,275; 0,814] \\
10 & 0,103 & 0,476 [0,272; 0,761] & 0,748 [0,628; 0,865] \\
\bottomrule
\end{tabular}
\end{table}

La solución con dos grupos tiene el mayor Silhouette del barrido y la mayor
concordancia mediana, pero su ARI de 0,507 sigue lejos de la estabilidad del
Nivel~1 (ARI mediano 0,958). La solución de diez grupos tampoco reproduce una
tipología robusta: aunque su NMI es mayor, su ARI mediano es 0,476, y contiene
dos subgrupos unitarios. En consecuencia, el Nivel~2 se limita en el cuerpo del
texto a una separación exploratoria amplia en dos bloques de 38 y 16 hospitales;
no se sostienen diez perfiles funcionales generalizables. La asignación de diez
subgrupos y sus perfiles descriptivos se conserva en el Anexo como material
suplementario.

Los casos $S4$ (Hospital Clínico San Borja--Arriarán) y $S9$ (Hospital Dr. Gustavo
...
\caption{Búsqueda del número de subclústeres $K_{sub}$ para el Núcleo
Generalista (Nivel 2, $n=54$).}
\label{tab:metricas-nivel2}
\begin{tabular}{c c c c c l}
\toprule
\textbf{$K_{sub}$} & \textbf{Silhouette} & \textbf{Davies-Bouldin} &
\textbf{Unitarios} & \textbf{$n\geq4$} & \textbf{Tamaños} \\
\midrule
2 & 0,169 & 2,424 & 0 & 2 & 38, 16 \\
3 & 0,080 & 2,376 & 0 & 3 & 22, $2\times16$ \\
4 & 0,100 & 2,052 & 0 & 4 & 22, 16, 9, 7 \\
5 & 0,100 & 1,692 & 1 & 4 & 22, 15, 9, 7, 1 \\
6 & 0,105 & 1,476 & 2 & 4 & 22, 15, 8, 7, $2\times1$ \\
7 & 0,121 & 1,367 & 2 & 4 & 22, 15, 8, 4, 3, $2\times1$ \\
8 & 0,120 & 1,350 & 2 & 5 & 22, 9, 8, 6, 4, 3, $2\times1$ \\
9 & 0,123 & 1,290 & 2 & 5 & 22, 9, 6, 5, 4, $2\times3$, $2\times1$ \\
\bfseries 10 & \bfseries 0,103 & \bfseries 1,316 & \bfseries 2 &
\bfseries 6 & \bfseries 17, 9, 6, $2\times5$, 4, $2\times3$, $2\times1$ \\
\bottomrule
\multicolumn{6}{l}{\footnotesize $a\times b$: $a$ grupos de tamaño $b$.}
\end{tabular}
\end{table}

La Figura~\ref{fig:metricas-nivel2} muestra que ninguna partición del barrido
alcanza un Silhouette comparable al del Nivel~1. El mayor valor corresponde a
$K_{sub}=2$ ($0{,}169$), mientras que el menor Davies--Bouldin corresponde a
$K_{sub}=9$ ($1{,}290$). Por tanto, $K_{sub}=10$ no se interpreta como una
solución óptima según estas métricas internas.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.78\textwidth]{img/metricas_nivel2.png}
\caption{Métricas internas del subclustering del Nivel 2 sobre los 54 hospitales
del núcleo generalista. El mayor Silhouette corresponde a $K_{sub}=2$, mientras
que el menor Davies--Bouldin corresponde a $K_{sub}=9$.}
\label{fig:metricas-nivel2}
\end{figure}

La solución $K_{sub}=10$ se reporta como una representación descriptiva. Dentro
del barrido evaluado, es la configuración con el mayor número de subclústeres
que reúnen al menos cuatro hospitales, pues seis de sus diez grupos cumplen ese
umbral. Sin embargo, mantiene dos grupos unitarios y dos grupos de tres
hospitales. Por ello, esta elección no identifica una tipología funcional validada, sino que describe con mayor detalle la heterogeneidad interna del
núcleo generalista.

La Figura~\ref{fig:balance-nivel2} muestra el criterio de balance utilizado
para reportar esta solución. Aunque $K_{sub}=10$ aumenta el número de grupos
con al menos cuatro hospitales, la presencia de dos grupos unitarios limita el
alcance de la interpretación de los subgrupos.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.78\textwidth]{img/seleccion_nivel2.png}
\caption{Balance de tamaños para las soluciones del Nivel 2. Se muestran los
subclústeres con $n\geq4$, los grupos unitarios y los pares. En el panel, la
línea vertical identifica la solución descriptiva reportada,
$K_{sub}=10$.}
\label{fig:balance-nivel2}
\end{figure}

El alcance de estos resultados se limita a una descripción exploratoria. El
Silhouette global de la solución adoptada es bajo ($0{,}103$), lo que indica una
separación débil entre los subgrupos. Además, $S4$ y $S9$ son grupos unitarios,
por lo que no permiten estimar variabilidad interna ni sostener inferencia sobre
un perfil colectivo. Los subgrupos $S0$ y $S2$, con tres hospitales cada uno,
también requieren una interpretación limitada a sus integrantes. Cualquier
contraste por variable aplicado sobre las mismas características utilizadas en
el clustering se considera una caracterización descriptiva posterior al
agrupamiento, y no una validación independiente de la partición.

Para caracterizar descriptivamente los diez subclústeres, la
Tabla~\ref{tab:perfiles-nivel2} presenta las medianas de variables
clínico-operativas seleccionadas.

\begin{table}[htbp]
\centering
\caption{Medianas de perfiles clínico-operativos de los subclústeres del Núcleo
Generalista ($K_{sub}=10$).}
\label{tab:perfiles-nivel2}
\setlength{\tabcolsep}{4pt}
\resizebox{\textwidth}{!}{%
\begin{tabular}{l c c c c c c c c c c}
\toprule
\textbf{Variable} & \textbf{$S0$} & \textbf{$S1$} & \textbf{$S2$} &
\textbf{$S3$} & \textbf{$S4$} & \textbf{$S5$} & \textbf{$S6$} &
\textbf{$S7$} & \textbf{$S8$} & \textbf{$S9$} \\
\midrule
$n$ & 3 & 4 & 3 & 5 & 1 & 5 & 17 & 6 & 9 & 1 \\
Egresos por año & 5.941 & 5.296 & 5.810 & 15.070 & 16.809 & 9.419 &
9.148 & 19.801 & 20.589 & 20.564 \\
Estancia media (días) & 4,7 & 4,8 & 5,4 & 7,0 & 6,1 & 7,0 &
5,9 & 8,3 & 7,6 & 7,4 \\
Peso medio GRD & 0,753 & 0,801 & 0,756 & 0,978 & 0,960 & 0,951 &
0,928 & 1,085 & 1,120 & 1,225 \\
Egresos geriátricos & 29,5\% & 23,0\% & 22,6\% & 21,7\% & 15,1\% &
25,5\% & 26,9\% & 29,1\% & 24,8\% & 26,4\% \\
Ingresos programados & 8,0\% & 15,0\% & 16,2\% & 12,3\% & 46,5\% &
15,0\% & 21,3\% & 13,9\% & 29,8\% & 22,2\% \\
Uso de pabellón & 23,7\% & 36,4\% & 46,3\% & 43,3\% & 42,1\% &
44,9\% & 44,6\% & 42,6\% & 46,7\% & 43,2\% \\
Tasa de partos & 2,1\% & 3,1\% & 4,4\% & 4,3\% & 5,1\% &
3,4\% & 2,6\% & 2,8\% & 2,3\% & 1,9\% \\
\bottomrule
\end{tabular}%
}
...
A partir de las diferencias de la Tabla~\ref{tab:perfiles-nivel2}, se describen
los siguientes subgrupos. Estas descripciones no constituyen etiquetas
funcionales definitivas; se presentan para facilitar la lectura exploratoria de
los patrones observados.

\begin{itemize}
    \item \textbf{Subclúster $S0$ ($n=3$): hospitales de bajo volumen y baja
    actividad programada.} Registra una mediana de 5.941 egresos anuales,
    estancia media de 4,7 días, peso medio GRD de 0,753 y el menor uso de
    pabellón del conjunto ($23{,}7\%$). Está compuesto por:
    \begin{itemize}
        \item Hospital Claudio Vicuña (San Antonio);
        \item Hospital San José (Coronel);
        \item Hospital San José (Parral).
    \end{itemize}

    \item \textbf{Subclúster $S1$ ($n=4$): hospitales generales de bajo
    volumen.} Presenta 5.296 egresos anuales, estancia de 4,8 días y peso medio
    GRD de 0,801. Está compuesto por:
    \begin{itemize}
        \item Hospital Provincial Dr.\ Rafael Avaría (Curanilahue);
        \item Hospital de Quilpué;
        \item Hospital de Santa Cruz;
        \item Hospital de Villarrica.
    \end{itemize}

    \item \textbf{Subclúster $S2$ ($n=3$): hospitales de menor volumen con
    uso elevado de pabellón.} Mantiene volumen bajo (5.810 egresos), pero el uso
    de pabellón alcanza $46{,}3\%$ y la tasa de partos $4{,}4\%$. Está compuesto
    por:
    \begin{itemize}
        \item Hospital Adalberto Steeger (Talagante);
        \item Hospital San José (Melipilla);
        \item Hospital San Luis (Buin).
    \end{itemize}

    \item \textbf{Subclúster $S3$ ($n=5$): hospitales metropolitanos de
    volumen intermedio-alto.} Presenta una mediana de 15.070 egresos, estancia
    de 7,0 días, peso medio GRD de 0,978 y tasa de partos de $4{,}3\%$. Está
    compuesto por:
    \begin{itemize}
        \item Complejo Hospitalario San José (Santiago, Independencia);
        \item Hospital Dr.\ Félix Bulnes Cerda (Santiago, Quinta Normal);
        \item Hospital Dr.\ Luis Tisné B. (Santiago, Peñalolén);
        \item Hospital El Pino (Santiago, San Bernardo);
        \item Hospital Padre Alberto Hurtado (San Ramón).
    \end{itemize}

    \item \textbf{Subclúster $S4$ ($n=1$): observación individual de alta
    programación.} Corresponde al Hospital Clínico San Borja-Arriarán
    (Santiago, Santiago). Registra 16.809 egresos anuales y la mayor proporción
    de ingresos programados ($46{,}5\%$), por lo que se describe únicamente como
    una observación singular y no como un perfil generalizable.

    \item \textbf{Subclúster $S5$ ($n=5$): hospitales generales de volumen
    intermedio y estancia prolongada.} Presenta 9.419 egresos, estancia de
    7,0 días y peso medio GRD de 0,951. Está compuesto por:
    \begin{itemize}
        \item Hospital Dr.\ Antonio Tirado Lanas (Ovalle);
        \item Hospital San Juan de Dios (Curicó);
        \item Hospital San Juan de Dios (La Serena);
        \item Hospital San Martín (Quillota);
        \item Hospital de San Camilo (San Felipe).
    \end{itemize}

    \item \textbf{Subclúster $S6$ ($n=17$): bloque generalista heterogéneo de
    volumen medio.} Es el grupo de mayor tamaño. Tiene una mediana de 9.148
    egresos, estancia de 5,9 días y peso medio GRD de 0,928. Dada su amplitud y
    el bajo Silhouette global del Nivel~2, debe interpretarse como un bloque
    descriptivo amplio más que como un perfil homogéneo. Está compuesto por:
    \begin{itemize}
        \item Complejo Asistencial Dr.\ Víctor Ríos Ruiz (Los Ángeles);
        \item Hospital Base San José de Osorno;
        \item Hospital Dr.\ Carlos Cisternas (Calama);
        \item Hospital Dr.\ Ernesto Torres Galdames (Iquique);
        \item Hospital Dr.\ Juan Noé Crevanni (Arica);
        \item Hospital Dr.\ Mauricio Heyermann (Angol);
        \item Hospital Las Higueras (Talcahuano);
        \item Hospital Presidente Carlos Ibáñez del Campo (Linares);
        \item Hospital Provincial del Huasco Monseñor Fernando Ariztía Ruiz
        (Vallenar);
        \item Hospital Regional (Coihaique);
        \item Hospital San José (Victoria);
        \item Hospital San José del Carmen (Copiapó);
        \item Hospital San Juan de Dios (Los Andes);
        \item Hospital San Juan de Dios (San Fernando);
        \item Hospital San Pablo (Coquimbo);
        \item Hospital de Castro;
        \item Hospital de San Carlos.
    \end{itemize}

    \item \textbf{Subclúster $S7$ ($n=6$): hospitales de alto volumen y mayor
    estancia.} Registra 19.801 egresos anuales, una estancia media de 8,3 días,
    peso medio GRD de 1,085 y $29{,}1\%$ de egresos geriátricos. Está compuesto
    por:
    \begin{itemize}
        \item Hospital Barros Luco Trudeau (Santiago, San Miguel);
        \item Hospital Clínico Herminda Martín (Chillán);
        \item Hospital Clínico Metropolitano El Carmen Doctor Luis Valentín
        Ferrada;
        \item Hospital Clínico Metropolitano La Florida Dra.\ Eloisa Díaz
        Inzunza;
        \item Hospital Regional de Rancagua;
        \item Hospital de Puerto Montt.
    \end{itemize}

    \item \textbf{Subclúster $S8$ ($n=9$): hospitales de alto volumen,
    complejidad y actividad programada.} Presenta 20.589 egresos, estancia de
    7,6 días, peso medio GRD de 1,120, uso de pabellón de $46{,}7\%$ y la mayor
    proporción de ingresos programados entre los grupos no unitarios
    ($29{,}8\%$). Está compuesto por:
    \begin{itemize}
        \item Complejo Hospitalario Dr.\ Sótero del Río (Santiago, Puente Alto);
        \item Hospital Carlos Van Buren (Valparaíso);
        \item Hospital Clínico Regional (Valdivia);
        \item Hospital Clínico Regional Dr.\ Guillermo Grant Benavente
        (Concepción);
        \item Hospital Clínico de Magallanes Dr.\ Lautaro Navarro Avaria;
        \item Hospital Dr.\ César Garavagno Burotto (Talca);
        \item Hospital Dr.\ Hernán Henríquez Aravena (Temuco);
        \item Hospital Dr.\ Leonardo Guzmán (Antofagasta);
        \item Hospital San Juan de Dios (Santiago, Santiago).
    \end{itemize}

    \item \textbf{Subclúster $S9$ ($n=1$): observación individual de alta
    complejidad.} Corresponde al Hospital Dr.\ Gustavo Fricke (Viña del Mar).
    Presenta un peso medio GRD de 1,225, el mayor de los subgrupos del Nivel~2.
    Al ser un grupo unitario, esta descripción no representa una categoría
    funcional generalizable.
\end{itemize}
...
\begin{table}[htbp]
\centering
\caption{Intervalos percentilares empíricos del 95\,\% (percentiles 2{,}5 y 97{,}5) sobre 100 submuestras del 80\,\% de los hospitales.}
...
\begin{table}[htbp]
\centering
\caption{Resultados de la prueba de Kruskal-Wallis en el Nivel~1 con corrección Benjamini-Hochberg y tamaño de efecto $\varepsilon^2$ (ordenados de forma descendente por $\varepsilon^2$; $K=4$, $n=65$).}
...
La circularidad asociada a esta caracterización se examinó además mediante la prueba de permutación descrita en la Sección~\ref{sec:permutacion-circularidad}. En 500 repeticiones se permutó independientemente cada variable entre hospitales, preservando su distribución marginal, pero eliminando la estructura conjunta entre variables. Sobre cada matriz nula se repitió el flujo completo, que incluyó el
preprocesamiento, el clustering Ward con $K=4$, la prueba de
Kruskal-Wallis y la corrección BH.

En los datos observados, 26 de las 28 variables resultaron significativas. En contraste, bajo la distribución nula el número de variables significativas tuvo mediana igual a 1, percentil 95 igual a 5 y máximo igual a 10. Ninguna de las 500 repeticiones alcanzó o superó las 26 variables significativas observadas. Este resultado respalda la presencia de diferenciación empírica en los datos, pero no transforma las pruebas por variable en una validación externa, pues la caracterización sigue realizándose en el mismo espacio de información empleado para construir los clústeres.

En el Nivel~2 (Tabla~\ref{tab:kruskal-nivel2}), el análisis se restringe a los 54 hospitales del núcleo generalista y compara los diez subclústeres exploratorios ($S0$ a $S9$). En ella, 24 de las 28 variables presentan diferencias estadísticamente detectables entre subgrupos. Las variables con mayor tamaño de efecto son \texttt{peso\_medio\_grd} ($\varepsilon^2=0{,}766$), \texttt{tasa\_prematurez} ($\varepsilon^2=0{,}662$), \texttt{pct\_estancia\_larga} ($\varepsilon^2=0{,}653$), \texttt{egresos\_por\_anio} ($\varepsilon^2=0{,}615$), \texttt{pct\_obstetrica\_ingreso} ($\varepsilon^2=0{,}603$) y \texttt{pct\_programada} ($\varepsilon^2=0{,}595$).

En consecuencia, la subtipología exploratoria diferencia principalmente gradientes de complejidad clínica, composición de la casuística, intensidad de actividad, permanencia hospitalaria y modalidad de atención. Las variables \texttt{pct\_alta\_traslado}, \texttt{cv\_estancia}, \texttt{pct\_pediatrico} y \texttt{peso\_medio\_cma} no alcanzan significancia en BH. Este resultado no demuestra uniformidad entre subclústeres, sino que indica que no existe evidencia suficiente de diferencias para esas variables bajo este contraste y ajuste por multiplicidad.

\begin{table}[htbp]
\centering
\caption{Resultados de la prueba de Kruskal-Wallis en el Nivel~2 con corrección Benjamini-Hochberg y tamaño de efecto $\varepsilon^2$ (ordenados de forma descendente por $\varepsilon^2$; $K=10$, $n=54$).}
...
\midrule
peso\_medio\_grd
& 42,7 & $2{,}46 \times 10^{-6}$ & $6{,}88 \times 10^{-5}$ & 0,766 & Sí \\
tasa\_prematurez
& 38,1 & $1{,}67 \times 10^{-5}$ & $1{,}83 \times 10^{-4}$ & 0,662 & Sí \\
pct\_estancia\_larga
& 37,7 & $1{,}96 \times 10^{-5}$ & $1{,}83 \times 10^{-4}$ & 0,653 & Sí \\
egresos\_por\_anio
& 36,1 & $3{,}83 \times 10^{-5}$ & $2{,}56 \times 10^{-4}$ & 0,615 & Sí \\
pct\_obstetrica\_ingreso
& 35,5 & $4{,}76 \times 10^{-5}$ & $2{,}56 \times 10^{-4}$ & 0,603 & Sí \\
pct\_programada
& 35,2 & $5{,}49 \times 10^{-5}$ & $2{,}56 \times 10^{-4}$ & 0,595 & Sí \\
pct\_femenino\_fertil
& 34,3 & $7{,}80 \times 10^{-5}$ & $3{,}12 \times 10^{-4}$ & 0,576 & Sí \\
mortalidad\_media
& 33,4 & $1{,}15 \times 10^{-4}$ & $3{,}99 \times 10^{-4}$ & 0,554 & Sí \\
tasa\_partos
& 33,1 & $1{,}28 \times 10^{-4}$ & $3{,}99 \times 10^{-4}$ & 0,548 & Sí \\
pct\_urgencia
& 32,4 & $1{,}69 \times 10^{-4}$ & $4{,}72 \times 10^{-4}$ & 0,532 & Sí \\
entropia\_grd
& 31,7 & $2{,}21 \times 10^{-4}$ & $5{,}62 \times 10^{-4}$ & 0,517 & Sí \\
estancia\_media
& 31,4 & $2{,}52 \times 10^{-4}$ & $5{,}88 \times 10^{-4}$ & 0,509 & Sí \\
pct\_alta\_fallecido
& 30,6 & $3{,}41 \times 10^{-4}$ & $7{,}34 \times 10^{-4}$ & 0,492 & Sí \\
pct\_origen\_emergencia
& 27,3 & $0{,}001$ & $0{,}002$ & 0,417 & Sí \\
edad\_mediana
& 25,4 & $0{,}003$ & $0{,}005$ & 0,373 & Sí \\
comorbilidades\_promedio
& 25,3 & $0{,}003$ & $0{,}005$ & 0,370 & Sí \\
pct\_alta\_domicilio
& 24,4 & $0{,}004$ & $0{,}006$ & 0,350 & Sí \\
severidad\_media
& 24,3 & $0{,}004$ & $0{,}006$ & 0,347 & Sí \\
pct\_geriatrico
& 23,3 & $0{,}005$ & $0{,}008$ & 0,326 & Sí \\
pct\_origen\_referencia
& 22,6 & $0{,}007$ & $0{,}010$ & 0,308 & Sí \\
estancia\_mediana
& 21,9 & $0{,}009$ & $0{,}012$ & 0,294 & Sí \\
pabellones\_promedio
& 20,2 & $0{,}017$ & $0{,}021$ & 0,255 & Sí \\
tasa\_cma
& 18,4 & $0{,}030$ & $0{,}037$ & 0,214 & Sí \\
pct\_uso\_pabellon
& 17,6 & $0{,}040$ & $0{,}046$ & 0,196 & Sí \\
pct\_alta\_traslado
& 16,1 & $0{,}065$ & $0{,}073$ & 0,161 & No \\
cv\_estancia
& 15,4 & $0{,}081$ & $0{,}088$ & 0,145 & No \\
pct\_pediatrico
& 14,5 & $0{,}106$ & $0{,}110$ & 0,125 & No \\
peso\_medio\_cma
& 7,2 & $0{,}615$ & $0{,}615$ & 0,000 & No \\
\bottomrule
\end{tabular}
\end{table}

La magnitud de los tamaños de efecto debe considerarse junto con la significancia. Por ejemplo, \texttt{peso\_medio\_grd}, \texttt{tasa\_prematurez} y \texttt{pct\_estancia\_larga} presentan los mayores valores de $\varepsilon^2$, por lo que ofrecen una caracterización particularmente informativa de las diferencias entre subgrupos. En contraste, variables significativas como \texttt{pct\_uso\_pabellon} ($\varepsilon^2=0{,}196$) o \texttt{tasa\_cma} ($\varepsilon^2=0{,}214$) muestran diferencias detectables, pero de menor magnitud relativa.

Por tratarse de un segundo nivel exploratorio construido sobre el mismo conjunto de variables, no corresponde interpretar los $p_{\text{BH}}$ como evidencia independiente de que los diez subclústeres representen categorías externas o definitivas. Su utilidad en esta sección es descriptiva: permite identificar las variables que separan con mayor intensidad los perfiles obtenidos y distinguirlas de aquellas para las que no se detectan diferencias suficientes bajo el ajuste aplicado.

Adicionalmente, se examinó la asociación entre la asignación de clústeres y la pertenencia a Servicios de Salud mediante una prueba de chi-cuadrado de independencia. En el Nivel~1 se obtuvo $\chi^2=65{,}329$ ($\text{gl}=84$, $p=0{,}935$), mientras que en el Nivel~2 se obtuvo $\chi^2=222{,}968$ ($\text{gl}=252$, $p=0{,}906$). En ambos niveles no se detectó una asociación estadísticamente significativa entre los clústeres y el Servicio de Salud.
...
asociación. Sus valores alcanzan $0{,}579$ en el Nivel~1 y $0{,}677$
...
$C0$ y los tres establecimientos del perfil monográfico $C3$ están clasificados
por MINSAL como de Alta Complejidad. Esta coincidencia describe la ubicación
administrativa de los perfiles más especializados identificados en el Nivel~1,
sin constituir una validación externa de la partición.
...
\begin{table}[htbp]
\centering
\caption{Prueba de permutación de la dispersión intragrupo normalizada, con 2.000 reasignaciones y tamaños de grupo preservados.}
...
obtuvo WSS/TSS $=0{,}616$, frente a $0{,}956$ para MINSAL; la diferencia
MINSAL--Ward fue $0{,}340$ (IC bootstrap 95\,\% $[0{,}176;0{,}540]$). En el
...
para MINSAL; la diferencia fue $0{,}407$ (IC 95\,\%
...
superioridad general de la clasificación funcional sobre la administrativa; sí
...
\begin{table}[htbp]
\centering
\caption{Variables retenidas por LASSO, frecuencia de selección en validación cruzada de cinco pliegues y coeficiente del modelo final.}
...
\begin{table}[htbp]
\centering
\caption{Desempeño predictivo fuera de muestra del modelo LASSO mediante validación cruzada estratificada de cinco pliegues.}
...
una señal de influencia global y no como un criterio de eliminación automática;
...
\begin{table}[htbp]
\centering
\caption{Hospitales marcados por al menos un criterio de detección. Los establecimientos en negrita cumplen dos o más criterios.}
\label{tab:outliers}
\footnotesize
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{img/atipicos_pca.png}
\caption{Proyección PCA de los establecimientos según la partición Ward $K=4$. Los círculos rojos corresponden a hospitales marcados por al menos un criterio de detección de atipicidad.}
...
La solución sin pandemia presenta un Silhouette de $0{,}356$ y tamaños de grupo $[3,51,2,9]$, frente al Silhouette de $0{,}400$ y los tamaños $[3,54,5,3]$ de la partición principal. La concordancia entre ambas soluciones alcanza $\text{ARI}=0{,}809$ y $\text{NMI}=0{,}750$, lo que indica una estabilidad importante, aunque no completa.

\begin{table}[htbp]
\centering
\caption{Tabla de contingencia entre la partición Ward $K=4$ del período completo y la obtenida al excluir 2020--2021.}
...
La partición obtenida mediante CLR+PCA reproduce exactamente la asignación Ward principal: $\text{ARI}=1{,}000$, $\text{NMI}=1{,}000$ y cero hospitales cambian de clúster. Los tamaños de los grupos se mantienen en $[3,54,5,3]$.

\begin{table}[htbp]
\centering
\caption{Tabla de contingencia entre la partición Ward $K=4$ con PCA convencional y la partición obtenida con CLR+PCA.}
...
Finalmente, la sensibilidad temporal afecta especialmente algunas componentes de casuística y la tasa de partos. Por ello, la interpretación de los perfiles funcionales globales cuenta con mayor respaldo que una lectura exhaustiva de las componentes específicas del PCA o de diferencias clínicas finas entre los grupos.
