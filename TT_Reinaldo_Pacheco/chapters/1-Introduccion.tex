...
Asimismo, en cumplimiento de las directrices académicas e institucionales sobre integridad científica de la Universidad de Santiago de Chile, se deja constancia de que el desarrollo conceptual, diseño metodológico, procesamiento de datos, análisis estadístico, interpretación de resultados y conclusiones presentadas en este trabajo de titulación son de autoría y responsabilidad intelectual exclusiva del estudiante. Se utilizaron herramientas de inteligencia artificial generativa (GPT 5.6 Terra) de manera complementaria y acotada como apoyo en la asistencia de redacción, estilo \LaTeX{} y depuración de scripts computacionales.
