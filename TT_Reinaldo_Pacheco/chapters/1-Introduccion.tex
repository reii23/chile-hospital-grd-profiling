...
un financiamiento equitativo~\citep{DIPRES_Programa05_2023}. Como solución de
contingencia se fijó posteriormente una tasa base única para toda la
red~\citep{DIPRES_Programa05_2023, SenadoFONASA_Q2_2023}, pero esa medida no
...
período 2019--2024, y en qué medida esa segmentación permite comparaciones más 
homogéneas que la clasificación administrativa vigente?}
\end{quote}
...
indicadores GRD de producción, complejidad y casuística presenta mayor
homogeneidad interna y estabilidad que la clasificación administrativa vigente
de los hospitales públicos chilenos de alta y mediana complejidad.

Esta hipótesis se sustenta en cuatro antecedentes desarrollados en el
Capítulo~\ref{cap:marco}: la evidencia nacional que reporta baja coherencia
interna de la clasificación administrativa del MINSAL respecto del
\textit{case-mix} real de los hospitales~\citep{Carlier2020, Giglio2021,
Villalobos2016}; la evidencia internacional de tipologías hospitalarias
construidas a partir de datos de producción~\citep{Chrusciel2021, Liu2025}; la
disponibilidad, en los registros GRD chilenos, de variables capaces de
representar casuística y complejidad clínica de forma estandarizada; y la
...
\begin{enumerate}
  ...
  \item Contrastar la segmentación funcional con la clasificación
        administrativa del MINSAL, mediante medidas comparables de
        homogeneidad interna y concordancia.
\end{enumerate}
